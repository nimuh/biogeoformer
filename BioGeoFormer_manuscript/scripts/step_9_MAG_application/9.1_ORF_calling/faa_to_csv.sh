...
input_file="/nfs5/MICRO/Thurber_Lab/jacob/MAG_processing_deepsea/non-redundant_MAGs_proteins/MAGs_combined_prodigal.faa"
output_file="/nfs5/MICRO/Thurber_Lab/jacob/MAG_processing_deepsea/non-redundant_MAGs_proteins/MAGs_combined_prodigal.csv"
