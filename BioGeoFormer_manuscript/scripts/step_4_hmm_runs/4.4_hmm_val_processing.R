...
folder_path <- "../../hmm_run_val_test_anti_split/val_output_hmm/"
...
head(filtered_unique_hmm_data_split[["40"]])
str(filtered_unique_hmm_data_split[["40"]])
...
output_dir <- "../../hmm_run_val_test_anti_split/val_processed_hmm/"
