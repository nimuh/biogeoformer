...
Built on the ESM-2 transformer architecture and fine-tuned on curated metabolic pathway databases (MCycDB, NCycDB, PCycDB, SCycDB), BioGeoFormer extends sequence-function inference beyond traditional homology-based tools. 
