...
Built on the ESM-2 transformer architecture, fine-tuned on curated metabolic pathway databases (MCycDB, NCycDB, PCycDB, SCycDB), and a temperature-scaled confidence function, BioGeoFormer extends sequence-function inference beyond traditional homology-based tools. 
